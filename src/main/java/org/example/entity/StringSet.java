...
public final class StringSet {
    ...
    public static SortedSet<String> findUniqueWords() {
        // İstenen karakterleri temizle ve sayıları çıkar
        String cleaned = TEXT
                .toLowerCase(java.util.Locale.ROOT)        // aynı kelimenin büyük küçük harflilerini tekilleştir
                .replaceAll("[\\.,!\\?\"]", " ")           // ., !, ?, " -> boşluk
                .replaceAll("\\d+", " ");                  // sayıları sil

        // Kelimelere böl ve TreeSet'e ekle (benzersiz + alfabetik)
